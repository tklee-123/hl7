...
from configs.db_config import CONNECT, SCHEMA, DB_TYPE
...
def main():
    ...
    mongo_connect_1 = MongoConnection(CONNECT[DB_TYPE]["DATABASE"])
    print(mongo_connect_1)
    log_main.log_info("log_main")

    # Access collections
    collection1 = mongo_connect_1.get_collection(SCHEMA["HL7"])
